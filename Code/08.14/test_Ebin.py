...
feature = feature.iloc[:,[1, 2, 3, 6, 7, 8, 11, 12, 13, 16, 17, 18, 20, 21, 23, 25, 26]]
label=dataset.iloc[:,-1].values

test_feature = test_dataset.iloc[:,1:]
test_feature = test_feature.iloc[:,[1, 2, 3, 6, 7, 8, 11, 12, 13, 16, 17, 18, 20, 21, 23, 25, 26]]
...
'''      
f1 mean:  0.9074185074185074
f1 std:  0.018199432479567984
'''     
