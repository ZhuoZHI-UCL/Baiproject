...
feature = feature.iloc[:,[0, 1, 4, 5, 6, 9, 10, 11, 14, 15, 16, 19, 20, 22, 24, 25]]
label=dataset.iloc[:,-2].values

test_feature = test_dataset.iloc[:,1:]
test_feature = test_feature.iloc[:,[0, 1, 4, 5, 6, 9, 10, 11, 14, 15, 16, 19, 20, 22, 24, 25]]
...
print('All done!')
'''      
r2 mean:  0.7984155428120587
r2 std:  0.06962860793214651
rmse mean:  2.76468406110881
rmse std:  0.4681210352248482
'''     
