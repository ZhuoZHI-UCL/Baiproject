...
feature = feature.iloc[:,[0, 2, 4, 5, 7, 9, 10, 12, 14, 15, 17, 19, 23, 24, 25, 26]]
label=dataset.iloc[:,-2].values

test_feature = test_dataset.iloc[:,1:]
test_feature = test_feature.iloc[:,[0, 2, 4, 5, 7, 9, 10, 12, 14, 15, 17, 19, 23, 24, 25, 26]]
...
prediction_dataset['GCOOH'] = test_pred_mean
prediction_dataset.to_excel('/scratch/uceezzz/Project/Baiproject/Dataset/prediction.xlsx')
print('All done!')
'''      
r2 mean:  0.7059339015447262
r2 std:  0.09164770491354801
rmse mean:  1.1581472700059865
rmse std:  0.21625468560077493
'''     
