...
feature = feature.iloc[:,[0, 1, 2, 4, 5, 6, 7, 9, 10, 11, 12, 14, 15, 16, 17, 19, 21, 23, 24, 25, 26]]
label=dataset.iloc[:,-1].values

test_feature = test_dataset.iloc[:,1:]
test_feature = test_feature.iloc[:,[0, 1, 2, 4, 5, 6, 7, 9, 10, 11, 12, 14, 15, 16, 17, 19, 21, 23, 24, 25, 26]]
...
prediction_dataset['GH'] = test_pred_mean
prediction_dataset.to_excel('/scratch/uceezzz/Project/Baiproject/Dataset/prediction.xlsx')
print('All done!')

'''      
r2 mean:  0.7661209173755257
r2 std:  0.061439369909760774
rmse mean:  1.2222908024383259
rmse std:  0.26363706649496743
'''     
