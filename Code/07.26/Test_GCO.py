...
feature = feature.iloc[:,[0, 1, 3, 4, 5, 6, 8, 9, 10, 11, 13, 14, 15, 16, 18, 19, 21, 22, 23, 24, 26]]
label=dataset.iloc[:,-3].values

test_feature = test_dataset.iloc[:,1:]
test_feature = test_feature.iloc[:,[0, 1, 3, 4, 5, 6, 8, 9, 10, 11, 13, 14, 15, 16, 18, 19, 21, 22, 23, 24, 26]]
...
print('All done!')
'''      
r2 mean:  0.7218845457284642
r2 std:  0.14456143296288815
rmse mean:  1.3335399190747994
rmse std:  0.45377991806576823
'''     
