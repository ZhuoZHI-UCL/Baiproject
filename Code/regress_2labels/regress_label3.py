#这个文件是回归一个新的目标，数据集是 Dataset\label_regression.xlsx
...
#要写入的新的excel
dataset_new=pd.read_excel('../../Save/pre_new_label.xlsx')
...
models=[    XGBRegressor(),
            ...
            SVR(C=8,gamma=0.07),
            MLPRegressor(hidden_layer_sizes=100, max_iter=430)
        ]
models_str=[
...
for name, model in zip(models_str, models):
    ...
    for train_index, test_index in kf.split(feature):
        ...
        #     print('RandomForestRegressor model is the best and the label1 of 20000 data is pred')
...
# dataset_new['Ebin']=label1_sum
# dataset_new.to_excel('../../Save/pre_new_label.xlsx', index=False)
print('All finished')
